...
import es.davidrico.jakarta.jpahibernate.dominio.ClienteDto;
...
public class HibernateQL {
    public static void main(String[] args) {
        ...
        List<ClienteDto> clientesDto = em.createQuery("select new es.davidrico.jakarta.jpahibernate.dominio.ClienteDto(c.nombre, c.apellido) from Cliente c", ClienteDto.class)
                .getResultList();
